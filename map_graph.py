"""Đồ thị đường đi giữa các map của Ninja School Online."""

from collections import deque


# Các cạnh được port từ TileMap.fieldBZ của Java client.
...
def find_map_path(start_map: int, target_map: int) -> list[int] | None:
    """Tìm đường đi ngắn nhất giữa hai map bằng BFS."""
