...
public final class GameScr extends mScreen implements IActionListener, IChatable {
    ...
    public final void gameAD() {
        ...
        if (!OptimizedTuning.SKIP_PERIODIC_GC && !HeadlessTuning.SKIP_PERIODIC_GC && Char.getMyChar().statusMe == 1 && GameCanvas.gameTick % 100 == 0) {
            System.gc();
        }

        if (!OptimizedTuning.SKIP_DECORATIONS) {
